                                    ...
                                    <div class="custom_dropdown">
                                        <div class="custom_dropdown_list">
                                            ...
                                            <ul class="custom_list clc">
                                                ...
                                                @foreach($listCat as $cate)
                                                    <li><a href="{{$cate->slug}}">{{$cate->name}}<i class="clc"></i></a></li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="cart">
                            <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                ...
                                <div class="cart_content">
                                    ...
                                    <div class="cart_price">100,000đ</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="main_nav_content d-flex flex-row">
                        ...
                        <div class="cat_menu_container">
                            ...
                            {{--    {{isset($listCat[0]['name'])?$listCat[0]['name']:'Null !!'}}--}}



                            <ul class="cat_menu">
                                @foreach($listCat as $cate)
                                    <li><a href="{{$cate->slug}}">{{$cate->name}}<i class="fas fa-chevron-right ml-auto"></i></a></li>
                                @endforeach

{{--                                <li><a href="#">Máy ảnh<i class="fas fa-chevron-right"></i></a></li>--}}
{{--                                <li class="hassubs">--}}
{{--                                    <a href="#"> Phần cứng<i class="fas fa-chevron-right"></i></a>--}}
{{--                                    <ul>--}}
{{--                                        <li class="hassubs">--}}
                ...
                <div class="col">
                    ...
                    <div class="page_menu_content">
                        ...
                        <div class="menu_contact">
                            <div class="menu_contact_item"><div class="menu_contact_icon"><img src="/assets/frontend/images/phone_white.png" alt=""></div>+38 068 005 3570</div>
                            <div class="menu_contact_item"><div class="menu_contact_icon"><img src="/assets/frontend/images/mail_white.png" alt=""></div><a href="mailto:fastsales@gmail.com">fastsales@gmail.com</a></div>
                        </div>
                    </div>
                </div>
            </div>
